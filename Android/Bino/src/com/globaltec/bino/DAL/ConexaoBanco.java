...
public class ConexaoBanco extends SQLiteOpenHelper {
    ...
    private void cadastroInicial(SQLiteDatabase db) throws SQLException, Exception {
		...
		insertIntoValues.put(TesteClientRestContract.ConfiguracaoCONS.COLUMN_BASE_URL, "http://fleetcontrol-globaltec.rhcloud.com");
		insertIntoValues.put(TesteClientRestContract.ConfiguracaoCONS.COLUMN_CONTENT_URL, "/fleetcontrol/webresources/usuario?usr=#nm_login&pwd=#senha");
